...
export default function CurrencyMenuOption({
  text,
  name,
  Icon,
  value,
  ...
  return (
    ...
    >
      ...
      <select
        ...
        className="min-w-[78px] rounded-xl border border-gray-200 bg-white px-2 py-1.5 text-center text-xs font-medium text-[#A00012] outline-none transition focus:border-[#D40017] focus:ring-2 focus:ring-[#D40017]/10"
      >
